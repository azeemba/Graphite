...
We need Rust and web developers! Feel free to peruse the [documentation](docs/README.md) and hop onto Discord to ask where to start:
...
A good starting point for learning about the code structure and architecture is reading the [documentation](docs/README.md).
